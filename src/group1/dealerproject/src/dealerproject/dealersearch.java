 ...
 */
public class dealersearch extends javax.swing.JFrame {
...
//            String query = "SELECT* FROM dealer;";
            ...
            while (rs.next()) {
                ...
                model.addRow(new Object[] { name, phone_number, address, city, zipcode });
                size = size + 1;
            }
            if(size == 0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dealersearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dealersearch().setVisible(true);
            }
        });
    }
